...
for i in range(epochs):
    # y: salary, w: slope(how much salary increases by years of experience), x: years of experience, b: intercept(starting salary)
    y_pred = w*X + b
    # Computing gradients to minimize loss function: error in predicted y and actual y (y-y_pred)
    # Computing partial derivative for the cost function
